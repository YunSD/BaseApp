...
public static class FaceAiSharpBundleFactory
{
    ...
    public static IFaceDetectorWithLandmarks CreateFaceDetectorWithLandmarks(SessionOptions? sessionOptions = null)
    {
        ...
        var modelPath = Path.Combine(GetExeDir(), "models", "scrfd_2.5g_kps.onnx");
    ...
    {
        var modelPath = Path.Combine(GetExeDir(), "models", "arcfaceresnet100-11-int8.onnx");
    ...
    {
        var modelPath = Path.Combine(GetExeDir(), "models", "open_closed_eye.onnx");
    ...
    {
        var modelPath_27 = Path.Combine(GetExeDir(), "models", "2.7_80x80_MiniFASNetV2.onnx");
        var modelPath_400 = Path.Combine(GetExeDir(), "models", "4_0_0_80x80_MiniFASNetV1SE.onnx");
    ...
    {
        var modelPath = Path.Combine(GetExeDir(), "models", "depth_googlenet_slim.onnx");
