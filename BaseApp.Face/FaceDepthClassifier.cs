...
namespace FaceONNX
{
    ...
    /// </summary>
    public class FaceDepthClassifier
    {
        #region Private data
        /// <summary>
        /// Inference session.
        ...
        {
            _session = new InferenceSession(FaceAiSharpBundleFactory.GetDepthGooglenetSlim());
        }
        ...
        {
            _session = new InferenceSession(FaceAiSharpBundleFactory.GetDepthGooglenetSlim(), options);
        }
